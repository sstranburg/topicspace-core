# TKOS Read-Path Migration — Scope v0.3.2

**Date:** 2026-06-06 (v0.2 → v0.3.1 → v0.3.2, this version)
**Status:** LOCKED at v0.3.2. Scope artifact for the read-path code changes that v0.3.2 of the write-path requires.
